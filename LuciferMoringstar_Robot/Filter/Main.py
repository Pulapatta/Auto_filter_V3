    ...
    if (clicked == typed):
        ...
        if query.data.startswith("next"):
            ...
            if int(index) == 1:
                ...
                buttons.append(
                    [InlineKeyboardButton("🚀 Go to Next page 🚀", callback_data=f"next_{int(index)-1}_{keyword}")]
                )
                buttons.append(
        ...
        await query.answer("⚠️ ബ്രോ , മറ്റുള്ളവർ റിക്വസ്റ്റ്  ചെയ്ത് മൂവിയിൽ കുത്തി നോക്കാതെ ബ്രോന് വേണ്ടത് ബ്രോ ടെക്സ്റ്റ്  ചെയ്യുക.🤒 <code>/n</code>⚠️ Bro , Search Your Own File , Don't Click Others Requested Files .🤒",show_alert=True)

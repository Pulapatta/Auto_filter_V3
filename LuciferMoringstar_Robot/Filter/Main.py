...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if (clicked == typed):
        ...
        await query.answer("⚠️ ബ്രോ , മറ്റുള്ളവർ റിക്വസ്റ്റ്  ചെയ്ത് മൂവിയിൽ കുത്തി നോക്കാതെ ബ്രോന് വേണ്ടത് ബ്രോ ടെക്സ്റ്റ്  ചെയ്യുക.🤒    ⚠️ Bro , Search Your Own File , Don't Click Others Requested Files .🤒",show_alert=True)
